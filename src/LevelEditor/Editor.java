...
public class Editor
{
    ...
    public Point getSize() { return new Point(field.length, field[0].length); }

    public void setCellType(int x, int y, Types type) { field[y][x] = type; }
    public Types getCellType(int x, int y) { return field[y][x]; }
    ...
    public Point getSnakeCoords() throws IndexOutOfBoundsException
    {
    ...
    {
        Point snakeCoords = getSnakeCoords();
        Point size = getSize();
