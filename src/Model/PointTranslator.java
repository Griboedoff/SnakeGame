...
{
	static Vector directionToVector(Direction direction, Vector fieldVector, int dim)
	{
	...
	static Vector point2dToVector(Point2d point, Vector vectorIn, Vector fieldVector)
	{
