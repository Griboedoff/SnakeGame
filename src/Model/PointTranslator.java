...
{
    public static Point3d pointTo3D(Point2d point, Point3d fieldVector)
    {
    ...
    public static Point3d pointTo3D(int x, int y, Point3d fieldVector)
    {
        return pointTo3D(new Point2d(x, y), fieldVector);
    }

    public static Point2d pointTo2D(Point3d point, Point3d fieldVector)
    {
        if (fieldVector.getX() != -1)
